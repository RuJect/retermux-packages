...
##
TERMUX_APP__PACKAGE_NAME="org.ruject.termux"
...
# Default value: `com.termux`
##
TERMUX_APP__NAMESPACE="org.ruject.termux"
...
TERMUX_REPO_APP__PACKAGE_NAME="org.ruject.termux"
TERMUX_REPO_APP__DATA_DIR="/data/data/${TERMUX_REPO_APP__PACKAGE_NAME}"
TERMUX_REPO__CORE_DIR="/data/data/${TERMUX_REPO_APP__PACKAGE_NAME}/termux/core"
TERMUX_REPO__APPS_DIR="/data/data/${TERMUX_REPO_APP__PACKAGE_NAME}/termux/app"
TERMUX_REPO__ROOTFS="/data/data/${TERMUX_REPO_APP__PACKAGE_NAME}/files"
TERMUX_REPO__HOME="/data/data/${TERMUX_REPO_APP__PACKAGE_NAME}/files/home"
TERMUX_REPO__PREFIX="/data/data/${TERMUX_REPO_APP__PACKAGE_NAME}/files/usr"
...
# Path to CGCT tools
CGCT_DEFAULT_PREFIX="${TERMUX_APP__DATA_DIR}/files/usr/glibc"
